            ...
            return (
              <>
                <div className="flex justify-between items-center mb-1.5">
                  <span className={["font-label text-[9px] uppercase tracking-widest", urgent ? "text-[#a8432a]" : "text-outline"].join(" ")}>
                ...
                <div className="h-0.5 bg-outline-variant/20 w-full overflow-hidden">
                  <div
                    className={["h-full", urgent ? "bg-[#a8432a]" : "bg-primary"].join(" ")}
                    style={{ width: `${pct}%` }}
                  />
                </div>
              </>
          ...
          {(() => {
            ...
            if (msLeft <= 0) {
              return (
                <>
                  <div className="flex justify-between items-center mb-1.5">
                    <span className="font-label text-[9px] uppercase tracking-widest text-[#a8432a]">Edice uzavřena</span>
                  </div>
            ...
            return (
              <>
                ...
                <div className="h-0.5 bg-outline-variant/20 w-full overflow-hidden">
                  <div
                    className={["h-full transition-all", urgent ? "bg-[#a8432a]" : "bg-primary"].join(" ")}
                    style={{ width: `${pct}%` }}
                  />
                </div>
              </>
