        ...
        <PhotoLightbox src={imageUrl} alt={imageAlt}>
          ...
          >
            ...
            >
              ...
              {hasFrame ? (
                <div className="bg-[#fdfbf6] p-3 md:p-4 inline-flex">
            ...
            {/* Frame label */}
            {hasFrame && (
              <div className="absolute bottom-3 left-1/2 -translate-x-1/2 px-3 py-1.5 bg-[#2f2a22]/50 backdrop-blur-sm">
                <span className="font-label text-[9px] uppercase tracking-widest text-[#f7f3ec]/70 whitespace-nowrap">
            ...
            {/* Zoom hint */}
            <div className="absolute bottom-3 right-3 flex items-center gap-2 bg-[#fdfbf6]/80 backdrop-blur-sm px-3 py-1.5 border border-[#2f2a22]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
