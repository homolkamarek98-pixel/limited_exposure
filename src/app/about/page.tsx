  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="bg-mocha text-on-primary px-6 md:px-12 pt-24 md:pt-32 pb-20 md:pb-28">
          <div className="max-w-screen-2xl mx-auto">
            <span className="font-label text-[10px] uppercase tracking-widest text-on-primary/40 block mb-12">
              Otisk · O projektu
            </span>
            <h1 className="serif-display text-6xl md:text-8xl lg:text-[7rem] font-semibold tracking-tighter leading-[0.9] max-w-5xl mb-16">
          ...
          <div className="max-w-screen-2xl mx-auto px-6 md:px-12">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-16 items-start">
              <div className="md:col-span-4 md:sticky md:top-32">
                ...
                <h2 className="serif-display text-3xl md:text-4xl font-semibold tracking-tighter leading-tight">
          ...
          <div className="max-w-screen-2xl mx-auto px-6 md:px-12">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-16">
              <div className="md:col-span-4">
                ...
                <h2 className="serif-display text-3xl md:text-4xl font-semibold tracking-tighter leading-tight mb-6">
          ...
          <div className="max-w-screen-2xl mx-auto px-6 md:px-12">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-16 items-center">
              ...
              <div className="md:col-span-5">
                <div className="bg-surface-container-highest p-8 md:p-12 aspect-[4/5] flex flex-col justify-between">
                  <div className="space-y-3">
                    ...
                    <div className="serif-display text-4xl font-semibold tracking-tighter">Hahnemühle<br />Photo Rag<br />Baryta</div>
                  </div>
              ...
              <div className="md:col-span-6 md:col-start-7 space-y-8">
                ...
                <h2 className="serif-display text-4xl md:text-5xl font-semibold tracking-tighter leading-tight">
                  Tisk, který přetrvá.
                </h2>
        ...
        {/* ── Certifikát ─────────────────────────────────── */}
        <section className="bg-mocha text-on-primary py-24 md:py-32">
          <div className="max-w-screen-2xl mx-auto px-6 md:px-12">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-16 items-center">
              ...
              {/* Vizuál certifikátu */}
              <div className="md:col-span-5 md:col-start-8">
                <div className="bg-[#f7f3ec] text-primary p-8 md:p-10 space-y-6 border border-on-primary/10">
                  <div className="flex justify-between items-start">
                    <span className="font-label text-[10px] uppercase tracking-widest text-outline">Certifikát pravosti</span>
                    <span className="font-label text-[10px] uppercase tracking-widest text-outline">Otisk</span>
                  </div>
                  <div className="border-t border-outline-variant/30 pt-6 space-y-1">
                    <div className="serif-display text-2xl font-semibold tracking-tighter">Název díla</div>
        ...
        <section className="py-24 md:py-32 bg-surface">
          <div className="max-w-screen-2xl mx-auto px-6 md:px-12">
            <div className="text-center mb-16 md:mb-20 space-y-4">
              ...
              <h2 className="serif-display text-4xl md:text-5xl font-semibold tracking-tighter">Dvě kategorie. Jeden standard.</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border border-outline-variant/20">
              <div className="p-10 md:p-14 space-y-6 border-b md:border-b-0 md:border-r border-outline-variant/20">
                ...
                <h3 className="serif-display text-3xl font-semibold tracking-tighter">Fotografové na vzestupu.</h3>
                <p className="font-body text-base text-on-surface-variant leading-relaxed">
              ...
              <div className="p-10 md:p-14 bg-mocha text-on-primary space-y-6">
                <span className="font-label text-[10px] uppercase tracking-widest text-on-primary/40 block">Signature Series</span>
                <h3 className="serif-display text-3xl font-semibold tracking-tighter">Prémiová edice.</h3>
        ...
        <section className="bg-surface-container-low py-24 md:py-32">
          <div className="max-w-screen-2xl mx-auto px-6 md:px-12 text-center space-y-10">
            <h2 className="serif-display text-5xl md:text-7xl font-semibold tracking-tighter leading-[0.95] max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/gallery"
                className="bg-mocha text-on-primary px-12 py-5 font-label text-xs uppercase tracking-widest hover:opacity-90 transition-opacity"
              >
                Vybrat dílo
              </Link>
              <Link
