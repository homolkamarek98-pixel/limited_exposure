      ...
      <main className="max-w-screen-2xl mx-auto">
        ...
        <section className="flex flex-col md:flex-row min-h-[600px] md:min-h-[780px] px-6 md:px-12 pt-12 md:pt-16 gap-12 md:gap-16 items-center">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-start pb-8 md:pb-0">
            ...
            <h1 className="serif-display font-semibold text-6xl md:text-8xl tracking-tighter leading-none mb-8">
            ...
            <div className="max-w-md">
              ...
              <button className="bg-mocha text-on-primary px-10 py-5 font-label text-xs uppercase tracking-widest hover:opacity-90 transition-all">
                Sledovat fotografa
              </button>
            </div>
          </div>
        ...
        <section className="mx-6 md:mx-12 mb-24 bg-mocha text-on-primary p-12 md:p-16">
