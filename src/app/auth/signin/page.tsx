    ...
    <div className="min-h-screen bg-surface flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        <div className="bg-surface-container-low p-10 md:p-12 border border-outline-variant/20">
          <h1 className="serif-display text-3xl font-semibold tracking-tighter mb-2">Přihlášení</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-mocha text-on-primary py-4 font-label text-xs uppercase tracking-[0.2em] font-bold hover:opacity-90 transition-opacity disabled:opacity-40"
            >
