  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#f7f3ec]">
        ...
        {/* Verification header */}
        <section className="bg-mocha text-[#f7f3ec] px-6 md:px-12 py-16 md:py-20">
          <div className="max-w-screen-2xl mx-auto">
            <div className="flex items-start gap-6">
              ...
              <div>
                ...
                <h1 className="font-headline text-3xl md:text-5xl font-semibold tracking-tighter uppercase leading-tight">
                  Certifikát pravosti<br />byl ověřen.
                </h1>
                <p className="font-body text-[#f7f3ec]/50 text-sm mt-4 max-w-lg">
        ...
        <div className="max-w-screen-2xl mx-auto px-6 md:px-12 py-16 md:py-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-7">
              <div className="bg-[#fdfbf6] border border-[#eee7d8] p-8 md:p-12">

                {/* Header certifikátu */}
                <div className="flex justify-between items-start mb-10 pb-8 border-b border-[#eee7d8]">
                  <div>
                    <span className="font-label text-[9px] uppercase tracking-[0.25em] text-[#b8ad96] block mb-1">
                      Certifikát pravosti
                    </span>
                    <span className="font-label text-[9px] uppercase tracking-[0.25em] text-[#b8ad96]">
                      Otisk · Archivní záznam
                    </span>
                  </div>
                  <div className="text-right">
                    <span className="font-mono text-xs text-[#b8ad96] block">{certificate.serialNumber}</span>
                  </div>
                </div>
                ...
                <div className="flex gap-6 mb-10">
                  ...
                  />
                  <div>
                    <h2 className="font-headline text-2xl md:text-3xl font-semibold uppercase tracking-tight leading-tight mb-1">
                      {photo.title}
                    </h2>
                    <Link
                      href={`/photographer/${photographer.id}`}
                      className="font-body text-base text-[#8e8779] hover:text-[#2f2a22] transition-colors"
                    >
                      {authorName}
                    </Link>
                  </div>
                ...
                {/* Specifikace */}
                <div className="grid grid-cols-2 gap-6 mb-10 pb-10 border-b border-[#eee7d8]">
                  {[
                    ...
                    <div key={label}>
                      <span className="font-label text-[9px] uppercase tracking-widest text-[#b8ad96] block mb-1">{label}</span>
                ...
                <div className="flex justify-between items-end">
                  <div>
                    <span className="font-label text-[9px] uppercase tracking-widest text-[#b8ad96] block mb-3">Podpis fotografa</span>
                    <span className="font-body italic text-2xl text-[#cabfa9]">{authorName}</span>
                  </div>
                  <div className="text-right">
                    <span className="font-label text-[9px] uppercase tracking-widest text-[#b8ad96] block mb-2">QR ověření</span>
                    {/* QR placeholder — generuje se automaticky z URL */}
                    <div className="w-16 h-16 bg-[#f4efe4] border border-[#eee7d8] flex items-center justify-center">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#cabfa9" strokeWidth="1.5">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              {/* Fotograf */}
              <div className="bg-[#fdfbf6] border border-[#eee7d8] p-6">
                <span className="font-label text-[9px] uppercase tracking-widest text-[#b8ad96] block mb-4">Fotograf</span>
                <p className="font-headline text-xl font-bold mb-1">{authorName}</p>
                <Link
                  href={`/photographer/${photographer.id}`}
                  className="font-label text-[10px] uppercase tracking-widest text-[#8e8779] hover:text-[#2f2a22] transition-colors"
                >
                  Zobrazit portfolio →
                </Link>
              </div>
              ...
              <div className="bg-[#fdfbf6] border border-[#eee7d8] p-6">
                <span className="font-label text-[9px] uppercase tracking-widest text-[#b8ad96] block mb-4">
                  O archivním záznamu
                </span>
              ...
              <Link
                ...
                className="block w-full text-center border border-[#eee7d8] bg-[#fdfbf6] font-label text-[10px] uppercase tracking-widest py-4 hover:border-[#2f2a22] transition-colors"
              >
                Zobrazit edici →
              </Link>
