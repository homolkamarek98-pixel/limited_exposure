    ...
    <>
      ...
      <main className="max-w-screen-2xl mx-auto px-6 md:px-12 pt-16 md:pt-24 pb-32">
        ...
        <div className="border-b border-outline-variant/30 pb-12 mb-16 md:mb-20">
          ...
          <h1 className="serif-display text-5xl md:text-7xl font-semibold tracking-tighter leading-none">
            Autoři
          </h1>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h2 className="serif-display text-2xl md:text-4xl font-semibold tracking-tighter leading-none mb-2 group-hover:opacity-60 transition-opacity">
                    {name}
                  </h2>
                  {p.instagram && (
